                    ...
                    <div class="row m-l-0 m-r-0">
                        <div class="col-sm-4 bg-c-lite-green user-profile">
                            <div class="card-block text-center text-white">
                                <div class="m-b-5"> <img src="https://img.icons8.com/bubbles/100/000000/user.png" class="img-radius" alt="User-Profile-Image"> </div>
                                <h5 class="f-w-600">Hembo Tingor</h5>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <h5 class="m-b-20 m-t-40 p-b-5 b-b-default f-w-600">Boards</h5>
                                <div class="row">
                                    <div class="col-sm-6">
