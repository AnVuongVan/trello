...
<head>
    ...
    <link href="{{ asset('assets/css/dragdrop.css') }}" rel="stylesheet">
    ...
    <div id="root" class="root">
        <div class="board-container">
            <div class="nav">
                ...
                <div class="nav-icon nav-btn">
                    ...
                    <span style="margin-left: 10px">Group 12</span>
                </div>

                <div class="member-badge mod-round center" data-user="Kuuhaku">
            ...
            <div id="board" class="board">
                <div class="board-header">
                    ...
                    <div class="board-vertical" style="width: 2px; height: 80%; background-color: rgba(0, 0, 0, .5); margin-left: 10px; margin-right: 10px;">
        ...
        <div class="window-overlay hide" id="window-overlay">
            <div id="window" class="window">
                <div class="window-close-btn center">
                    <i class="fas fa-times"></i>
                </div>
                <div class="window-card-detail">
                    <div class="window-header">
                        <div id="window-header-label" class="window-header-label">
                            <span></span>
                        </div>
                        <textarea id="window-header-edit" class="window-header-edit hide" spellcheck="false" autocomplete="off">
                        </textarea>
                    </div>
                    <div id="window-main-col" class="window-main-content">
                        <div class="window-main-col">
                            <div id="card-detail" class="window-module card-detail">
                                ...
                                <div id="member-list" class="card-detail-item member hide">
                                    <span class="card-detail-item-header">Member</span>
                                    <div class="member-list">
                                        <div class="member-badge mod-round center">
                                            <span>K</span>
                                        </div>
                                        <div class="card-detail-item-add-btn mod-round center">
